class Daily < ApplicationRecord
  ...
  validates :uploader_id, :location_id, :month, :day, :min, :max, :precipitation, :snow_cover, presence: { message: "must be given" }
  validates :uploader_id, format: { with: /\A[a-zA-Z]+\z/,
